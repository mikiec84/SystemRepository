#!/bin/bash
#
# This script is run prior to deployment of component ComponentLaserHokuyoURGServer
...
#source $REFERENCED_PROJECT_ComponentLaserHokuyoURGServer/smartsoft/src/predeploy.sh
