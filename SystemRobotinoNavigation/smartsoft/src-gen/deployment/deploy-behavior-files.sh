...
$SMART_ROOT_ACE/lib/libCdlCoordinationService.so
$SMART_ROOT_ACE/lib/libMapperCoordinationService.so
$SMART_ROOT_ACE/lib/libPlannerCoordinationService.so
$SMART_ROOT_ACE/lib/libLocalizationCoordinationService.so
"
