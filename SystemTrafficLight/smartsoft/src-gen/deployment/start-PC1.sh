...
# Component instance ComponentTrafficLightTest
echo
echo "############################################"
echo "## Starting component instance ComponentTrafficLightTest"
cd $SCRIPT_DIR
echo "executing startstop-hooks-ComponentTrafficLightTest.sh (errors might be ignored)"
bash startstop-hooks-ComponentTrafficLightTest.sh pre-start
cd $SCRIPT_DIR/ComponentTrafficLightTest_data
rm -f "../ComponentTrafficLightTest.log"
xterm -l -lf "../ComponentTrafficLightTest.log" -title "ComponentTrafficLightTest@PC1 Component" -hold -e "export LD_LIBRARY_PATH=$SCRIPT_DIR:\$LD_LIBRARY_PATH; $SCRIPT_DIR/ComponentTrafficLightTest -filename=$SCRIPT_DIR/ComponentTrafficLightTest.ini; echo; echo; echo 'ComponentTrafficLightTest exited.'; echo; /bin/bash --login" &
echo $! >> $PID_XTERM
echo ComponentTrafficLightTest >> $PID_COMPONENT_NAMES
cd $SCRIPT_DIR
bash startstop-hooks-ComponentTrafficLightTest.sh post-start
echo -e "\n\n\n"
...
stop)
cd $SCRIPT_DIR
bash startstop-hooks-ComponentTrafficLightTest.sh pre-stop
...
bash startstop-hooks-ComponentTrafficLightTest.sh post-stop
