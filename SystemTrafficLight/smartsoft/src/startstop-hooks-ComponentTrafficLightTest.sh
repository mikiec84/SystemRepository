#!/bin/bash
#
# Start-Stop-Hooks for component ComponentTrafficLightTest
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentTrafficLightTest.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentTrafficLightTest.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentTrafficLightTest.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentTrafficLightTest.sh post-stop
