#!/bin/bash
#
# This script is run prior to deployment of component ComponentTrafficLightTest
...
#source $REFERENCED_PROJECT_ComponentTrafficLightTest/smartsoft/src/predeploy.sh
