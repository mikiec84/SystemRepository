#!/bin/bash
#
# Start-Stop-Hooks for component ComponentSkillInterfaceSlaveTest
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentSkillInterfaceSlaveTest.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentSkillInterfaceSlaveTest.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentSkillInterfaceSlaveTest.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentSkillInterfaceSlaveTest.sh post-stop
