#!/bin/bash
#
# Start-Stop-Hooks for component ComponentLaserFromRGBDServer
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentLaserFromRGBDServer.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentLaserFromRGBDServer.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentLaserFromRGBDServer.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentLaserFromRGBDServer.sh post-stop
