#!/bin/bash
#
# This script is run prior to deployment of component ComponentSkillInterfaceSlaveTest
...
#source $REFERENCED_PROJECT_ComponentSkillInterfaceSlaveTest/smartsoft/src/predeploy.sh
