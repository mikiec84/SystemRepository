#!/bin/bash
#
# Start-Stop-Hooks for component ComponentGMapping_rs
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentGMapping.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentGMapping.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentGMapping.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentGMapping.sh post-stop
