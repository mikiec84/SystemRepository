#!/bin/bash
#
# This script is run prior to deployment of component ComponentRobotinoLaserServer
...
#source $REFERENCED_PROJECT_ComponentRobotinoLaserServer/smartsoft/src/predeploy.sh
