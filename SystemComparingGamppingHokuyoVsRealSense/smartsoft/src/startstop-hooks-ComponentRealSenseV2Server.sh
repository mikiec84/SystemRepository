#!/bin/bash
#
# Start-Stop-Hooks for component ComponentRealSenseV2Server
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentRealSenseV2Server.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRealSenseV2Server.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRealSenseV2Server.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRealSenseV2Server.sh post-stop
